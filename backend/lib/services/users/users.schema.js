...
exports.userDataSchema = typebox_1.Type.Pick(exports.userSchema, ['email', 'password', 'firstName', 'lastName', 'companyUuid', 'role'], {
    $id: 'UserData'
});
...
exports.userQueryProperties = typebox_1.Type.Pick(exports.userSchema, ['uuid', 'email', 'firstName', 'lastName']);
...
// TODO: Enable this once authentication is back again
